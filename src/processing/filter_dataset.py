...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to save the filtered output dataset.",
    )
    parser.add_argument(
        "--location",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Filter by platform (e.g. Flickr, Mapillary).",
    )
    parser.add_argument(
        "--cluster_id", type=int, default=None, help="Filter by specific cluster ID."
    )
        ...
        if "Captured_At" in df.columns:
            ...
            if args.start_date:
                ...
                start_iso = (
                    ...
                    else f"{args.start_date}T00:00:00Z"
                )
            ...
            if args.end_date:
                end_iso = (
                    ...
                    else f"{args.end_date}T23:59:59Z"
                )
