...
def main():
    parser = argparse.ArgumentParser(
        description="EUNIS Ecosystem Map Representation Semantic Retrieval Benchmark."
    )
    parser.add_argument(
        "--csv_path",
        type=str,
    ...
    parser.add_argument(
        "--output_report",
        type=str,
        default="./benchmark_results/eunis_report.txt",
        help="Path to write the report summary.",
    )
    parser.add_argument(
        "--output_csv",
        type=str,
        default="./benchmark_results/eunis_results.csv",
    ...
    if args.discard_classes is not None:
        ...
        if os.path.exists(config_path):
            try:
                ...
                loaded_classes = cfg.get("eunis", {}).get("discard_classes")
