...
def main():
    ...
    parser.add_argument("--retrieval_caption_mode", type=str, default="natural",
                        choices=["natural", "natural_plus_human", "natural_plus_veg", "structured_only", "all_v3"],
    ...
    for item in selected_images:
        ...
        try:
            ...
            if args.retrieval_caption_mode == "natural":
                ...
                combined_caption = f"{visible_evidence} {human_activities_struc}" if human_activities_struc else visible_evidence
            elif args.retrieval_caption_mode == "natural_plus_veg":
                combined_caption = f"{visible_evidence} {type_of_vegetation_struc}" if type_of_vegetation_struc else visible_evidence
                ...
                caption_parts = [visible_evidence, human_activities, land_cover_usage, type_of_vegetation]
                combined_caption = " ".join([str(p).strip() for p in caption_parts if p and str(p).strip()])
