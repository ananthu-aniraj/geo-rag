...
def main():
    parser = argparse.ArgumentParser(description="Download sample images from Google Landmarks CSV.")
    ...
    parser.add_argument("--delay", type=float, default=0.2, help="Delay in seconds between requests per thread.")
