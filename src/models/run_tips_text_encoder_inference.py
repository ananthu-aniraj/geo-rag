...
r"""Running TIPS / TIPSv2 text encoder inference locally using local models.

Usage:
```python
python3 -m src.models.run_tips_text_encoder_inference \
...
from src.models import tips_text_encoder as text_encoder
