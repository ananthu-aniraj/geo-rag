...
- **Decoupled Retrieval Visualizer HTML Template**: Refactored the embedded HTML template out of `src/visualization/visualize_retrieval.py` into `templates/retrieval_dashboard.html`, reducing Python code bloat and aligning with the existing template architecture in `templates/`.
